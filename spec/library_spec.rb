...
RSpec.describe Library do
  ...
  describe "#checkout" do
    ...
    before do
      @book = subject.search("Harry Potter")
    ...
    describe "the book in memory" do
      before do
        @book = subject.books.detect { |object| object[:book][:title] == "Harry Potter" }
      end
    ...
    describe "in storage" do
      before do
        ...
        @book = books.detect { |object| object[:book][:title] == "Harry Potter" }
      end
